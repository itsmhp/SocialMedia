...
> **Catatan:** kuadran **"AI companion umum"** di peta bawah sengaja **kita hindari**. Kita main di *sweet spot*-nya: campfire, IRL lokal, komunitas minat.
...
```mermaid
quadrantChart
    title Peta Peluang - Permintaan vs Kepadatan Pesaing
    x-axis Pesaing Sedikit --> Pesaing Banyak
    y-axis Permintaan Rendah --> Permintaan Tinggi
    quadrant-1 Red Ocean
    quadrant-2 Sweet Spot
    quadrant-3 Niche Kecil
    quadrant-4 Hindari
    "Feed video pendek umum": [0.9, 0.9]
    "Microblog teks umum": [0.8, 0.55]
    "AI companion umum": [0.6, 0.85]
    "Campfire main bareng": [0.28, 0.8]
    "IRL / hangout lokal": [0.32, 0.72]
    "Komunitas minat + moderasi": [0.45, 0.75]
```
