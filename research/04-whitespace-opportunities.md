...
```mermaid
quadrantChart
    title Opportunity Map - Demand vs Competitor Density
    x-axis Few Competitors --> Many Competitors
    y-axis Low Demand --> High Demand
    quadrant-1 Red Ocean
    quadrant-2 Sweet Spot
    quadrant-3 Small Niche
    quadrant-4 Avoid
    "Generic short-video feed": [0.9, 0.9]
    "Generic text microblog": [0.8, 0.55]
    "Generic AI companion": [0.6, 0.85]
    "Campfire playing together": [0.28, 0.8]
    "Local IRL / hangout": [0.32, 0.72]
    "Interest community + moderation": [0.45, 0.75]
```
